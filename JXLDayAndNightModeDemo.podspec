...
Pod::Spec.new do |s|
  ...
  s.author             = { "金鑫亮" => "jinxinliang@lanou3g.com" }
  # Or just: s.author    = "金鑫亮"
  # s.authors            = { "金鑫亮" => "jinxinliang@lanou3g.com" }
  ...
  s.source       = { :git => "https://github.com/JinXinLiang/JXLDayAndNightModeDemo.git", :tag => “1.0.0” }
